/*
 * ExclustionEmailListItem.h
 *
 *  Created on: Apr 20, 2013
 *      Author: eghantous
 */

#ifndef EXCLUSTIONEMAILLISTITEM_H_
#define EXCLUSTIONEMAILLISTITEM_H_
...
class ExclustionEmailListItem : public bb::cascades::CustomControl, public ListItemListener {

	Q_OBJECT

public:
	ExclustionEmailListItem(Container *parent = 0);
	virtual ~ExclustionEmailListItem();
...
#endif /* EXCLUSTIONEMAILLISTITEM_H_ */
